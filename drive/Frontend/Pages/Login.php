...
?>  
    <div class="flex justify-center">
        <form class="my-20 w-96 border border-gray-100 p-7 shadow-xl">
            ...
            <div class="text-center">
                <a href="./Signup.php" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Don't have an account? Sign up</a><br>
