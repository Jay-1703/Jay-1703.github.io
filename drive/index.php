...
?>
  <!-- ============== Main content =================-->
  <section class="flex flex-wrap text-center md:text-left px-5 py-5 lg:py-20">
        ...
        <div class="inline">
          <button
            ...
            <span
              ...
              <a href="./Frontend/Pages/Signup.php">
                Get started
              </a>
            </span>
          </button>
  ...
  <section class="flex flex-wrap text-center justify-center md:text-left px-5 py-5 lg:py-20">
    <div class="grid md:grid-cols-3 sm:grid-cols-12 gap-x-5  gap-y-5">
      <div class="max-w-sm p-6 border border-gray-200 hover:shadow-lg">
        <div class="sm:flex justify-center lg:block">
          <img src="./Frontend/Images/access.webp" alt="" class="h-20">
        </div>
        <div class="mt-5">
      ...
      <div class="max-w-sm p-6 border border-gray-200 hover:shadow-lg">
        <div class="sm:flex justify-center lg:block">
          <img src="./Frontend/Images/share.webp" alt="" class="h-20">
        </div>
        <div class="mt-5">
      ...
      <div class="max-w-sm p-6 border border-gray-200 hover:shadow-lg">
        <div class="sm:flex justify-center lg:block">
          <img src="./Frontend/Images/security.webp" alt="" class="h-20">
        </div>
        <div class="mt-5">
